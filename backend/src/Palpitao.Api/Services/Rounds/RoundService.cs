...
public class RoundService : IRoundService
{
    ...
    public async Task<MatchDto> AddMatchAsync(Guid roundId, CreateMatchRequest request, Guid actingUserId, CancellationToken ct)
    {
        ...
        await ValidateCompetitionAndPhaseAsync(round.GroupId, competition, phase, ct);
    ...
    /// <summary>Rejects competitions/phases that do not belong to the group's certame
    /// type (e.g. a Premier League match in a FIFA World Cup group, or vice-versa).</summary>
    private async Task ValidateCompetitionAndPhaseAsync(Guid groupId, Competition competition, MatchPhase phase, CancellationToken ct)
    {
