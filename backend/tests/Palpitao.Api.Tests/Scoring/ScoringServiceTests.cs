...
public class ScoringServiceTests
{
    ...
    {
        var category = _sut.GetExactScoreCategory(home, away);

        Assert.Equal(expectedCategory, category);
        Assert.Equal(expectedPoints, _sut.GetBasePoints(category));
    }
    ...
    {
        var category = _sut.GetCategory(predHome, predAway, 2, 1);
    ...
    {
        var category = _sut.GetCategory(predHome, predAway, 1, 1);
    ...
    public void PremierLeague_BigSeven_derby_is_double()
    {
        ...
        Assert.Equal(2, _sut.GetMultiplier(Competition.PremierLeague, MatchPhase.Regular, true, true));
    }
    ...
    public void PremierLeague_non_BigSeven_is_single()
    {
        ...
        Assert.Equal(1, _sut.GetMultiplier(Competition.PremierLeague, MatchPhase.Regular, true, false));
    }

    [Fact]
    public void FACup_semifinal_is_double()
    {
        Assert.Equal(2, _sut.GetMultiplier(Competition.FACup, MatchPhase.FACupSemiFinal, false, false));
    }

    [Fact]
    public void FACup_final_is_triple()
    {
        Assert.Equal(3, _sut.GetMultiplier(Competition.FACup, MatchPhase.FACupFinal, false, false));
    }
    ...
    public void FACup_BigSeven_derby_in_regular_phase_is_double()
    {
        ...
        Assert.Equal(2, _sut.GetMultiplier(Competition.FACup, MatchPhase.Regular, true, true));
    }
    ...
    public void FACup_final_BigSeven_derby_uses_phase_only_no_accumulation()
    {
        ...
        Assert.Equal(3, _sut.GetMultiplier(Competition.FACup, MatchPhase.FACupFinal, true, true));
    }

    [Fact]
    public void Championship_normal_is_single()
    {
        Assert.Equal(1, _sut.GetMultiplier(Competition.Championship, MatchPhase.Regular, false, false));
    }

    [Fact]
    public void Championship_playoff_semifinal_is_double()
    {
        Assert.Equal(2, _sut.GetMultiplier(Competition.Championship, MatchPhase.PlayoffSemiFinal, false, false));
    }

    [Fact]
    public void Championship_playoff_final_is_double()
    {
        Assert.Equal(2, _sut.GetMultiplier(Competition.Championship, MatchPhase.PlayoffFinal, false, false));
    }

    [Fact]
    public void LeagueOne_is_always_double()
    {
        Assert.Equal(2, _sut.GetMultiplier(Competition.LeagueOne, MatchPhase.Regular, false, false));
    }
    ...
    public void ScorePrediction_applies_multiplier_to_exact_score()
    {
        ...
        var result = _sut.ScorePrediction(2, 1, 2, 1, Competition.PremierLeague, MatchPhase.Regular, true, true);
    ...
    public void ScorePrediction_wrong_is_zero_even_with_multiplier()
    {
        ...
        var result = _sut.ScorePrediction(0, 1, 2, 0, Competition.LeagueOne, MatchPhase.Regular, false, false);
