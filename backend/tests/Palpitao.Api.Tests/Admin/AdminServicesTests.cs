...
public class AdminServicesTests
{
    ...
    [Fact]
    public async Task Create_persists_the_tournament_type_and_update_keeps_it_immutable()
    {
        ...
        // An update must NOT change the certame type, even if a different one is sent.
