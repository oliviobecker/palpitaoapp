 ...
 * and League One markers, kickoff time, the teams, and the score once the match is
 * under way. When `editable` is set it shows edit/remove actions and emits the
 * corresponding match.
 */
@Component({
        ...
        <div class="card" [class.border-primary]="classic(m)" [class.border-warning]="leagueOne(m)">
          <div class="card-body py-2 px-3">
            <div class="d-flex flex-wrap gap-2 align-items-center mb-1">
              ...
              <app-match-status-badge [status]="m.status" />
            ...
            <div class="d-flex justify-content-between align-items-center gap-2">
              ...
              >
              @if (hasScore(m)) {
                <span class="badge text-bg-dark" style="flex: none"
...
export class MatchList {
  ...
  protected readonly hasScore = (m: RoundMatch) =>
