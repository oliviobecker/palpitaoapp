                ...
                <div class="row g-2">
                  <div class="col-12 col-sm-6">
                    <button
                      ...
                      [class.active]="form.controls.tournamentType.value === 'PalpitaoEngland'"
                      (click)="selectType('PalpitaoEngland')"
                    >
                  ...
                  <div class="col-12 col-sm-6">
                    <button
                      type="button"
                      class="btn btn-outline-secondary w-100 h-100 text-start p-3"
                      [class.active]="form.controls.tournamentType.value === 'FifaWorldCup'"
                      (click)="selectType('FifaWorldCup')"
                    >
                      <span class="fw-semibold d-block">{{
                        'tournamentType.fifaWorldCup' | translate
                      }}</span>
                      <span class="small d-block">{{
                        'createGroupType.worldCup' | translate
                      }}</span>
                    </button>
                  </div>
                </div>
                @if (form.controls.tournamentType.touched && form.controls.tournamentType.invalid) {
                  <div class="text-danger small mt-1">
                    {{ 'tournamentType.required' | translate }}
                  </div>
                }
              </div>
...
export class CreateGroup {
  ...
  selectType(type: string): void {
    ...
    this.form.controls.tournamentType.markAsTouched();
  }
